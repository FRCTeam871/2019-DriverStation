 ...
 * Is a collection of
 */
public class ArmstrongNetConfig extends AbstractNetConfig {
    private ArmstrongNetConfig armstrongNetConfig;
    ...
    public ArmstrongNetConfig(boolean isClient, NetworkTableInstance instance, String VERSION_VAL) {
